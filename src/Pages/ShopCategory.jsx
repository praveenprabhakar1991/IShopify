...
const ShopCategory = (props) => {
   ...
   return <>
      <div className='container'>
         <img src={props.banner} className='d-block w-100' />
         <div className='mt-5 d-flex justify-content-around'>
            ...
            <div className="dropdown">
               <button className="border-0 bg-transparent" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">                  
                  <span type='submit' className='btn btn-white border rounded-pill py-2 px-3 text-black-50 dropdown-toggle'>Sort by</span>
               </button>
                  ...
                  AllProducts.map((Datas) => {
                     if (props.category === Datas.category) {
                        return <div className="col-md-3 mt-5" key={Datas.id}>
                           <div className="card">
                           <Link to={`/Product/${Datas.id}`}><img src={Datas.Image} className="card-img-top" /></Link> <hr />
